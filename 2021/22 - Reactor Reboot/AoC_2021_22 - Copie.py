...
def resolve_part2():
    ...
    for i in range(1, len(line)):
        ...
        while len(explodedLst) > 0:
            ...
            for idx in range(len(regionLst) - 1, -1, -1):
                ...
                resExplode = explode(explodedLst[0], resIntersect)
    ...
    for idx, region in enumerate(regionLst):
        if region[0] == True:
            ...
            print("ADD", idx, region, regionSize(region), sum)
        else:
            sum -= regionSize(region)
            print("SUB", idx, region, regionSize(region), sum)
